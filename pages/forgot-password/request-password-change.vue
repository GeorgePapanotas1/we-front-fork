<template>
  <div class="min-h-screen flex flex-col justify-center items-center bg-white px-4 py-6 mt-20">
    <h1 class="text-center text-xl font-bold mb-6">Request Password Change</h1>
    ...
    <form @submit.prevent="submitForm" class="w-full max-w-sm space-y-4 mt-20">
      <div class="mb-20">
        <!-- New Password -->
        <div class="mb-10">
          <label class="block mb-1 font-semibold text-gray-700" for="password">Add your email</label>
          <input
              id="password"
              type="email"
              v-model="password"
